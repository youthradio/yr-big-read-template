...
NAME = "Youth Radio Big Read Template"
...
class JavascriptIncluder(Includer):
    """
    Pseudo-template tag that handles collecting Javascript and serving appropriate clean or compressed versions.
    """
...
class CSSIncluder(Includer):
    """
    Pseudo-template tag that handles collecting CSS and serving appropriate clean or compressed versions.
    """
    def __init__(self, *args, **kwargs):
        Includer.__init__(self, *args, **kwargs)
